...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name){
        ...
        image1.setBounds(0,0,1480,380);
        add(image1);
        
        
        
         qno= new JLabel();
        qno.setBounds(100,420,30,30);
        qno.setFont(new Font("SAN SERIF",Font.BOLD,20));
        add(qno);
        
        
        question= new JLabel();
        question.setBounds(130,420,800,30);
        question.setFont(new Font("SAN SERIF",Font.BOLD,20));
        add(question);
	...
	questions[0][0] = "Which is used to find and fix bugs in the Java programs.?";
        ...
        opt1.setBounds(130,470,700,30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt1);
        
        opt2= new JRadioButton();
        opt2.setBounds(130,500,700,30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt2);
        
        opt3= new JRadioButton();
        opt3.setBounds(130,530,700,30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt3);
        
        opt4= new JRadioButton();
        opt4.setBounds(130,560,700,30);
        ...
        next.setBounds(1100,600,100,30);
        ...
        lifeline.setBounds(1100,650,150,30);
        ...
        submit.setBounds(1100,700,100,30);
